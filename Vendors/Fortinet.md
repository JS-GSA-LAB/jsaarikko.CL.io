...
**Access Points (FortiAP):** Current lineup is the **K-series** (Wi-Fi 7): FAP-441K/443K (flagship 4x4, 21.3 Gbps, 2x10GbE, 802.3bt), 241K/243K (mid), 231K (entry, single 5GbE-class port), 244K (outdoor), 222KL (outdoor + LoRaWAN/LTE/GNSS — **dual-band, ~3.57 Gbps, no 6 GHz**). Added to dashboard 2026-07-02 (specs from datasheet; prices est., flagged [!]): **FAP-221K** (dual-band Wi-Fi7 entry), **FAP-23JK** (tri-band Wi-Fi7 wall-plate), **FAP-432G** (6E 4x4 outdoor), **FAP-432FR** (Wi-Fi6 4x4 C1D2 ruggedized), **FAP-831F** (Wi-Fi6 8x8 high-density). Also added FortiSwitch **FS-624F** (5G+25G MACsec), **FS-348G** (2.5G+10G MACsec), **FS-3032G** (32x100G DC core), **FS-T1024F-FPOE** (10G-BASE-T + 100G, 1440W bt). The older 6E/6 models (431G/433G/231G, 431F/433F/231F, U231F/U431F) have had their spec datasheets **retired from fortinet.com** — treat as superseded/unverified.
